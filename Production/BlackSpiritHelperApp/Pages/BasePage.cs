using BlackSpiritHelper.Animations;
        ...
        public async Task AnimateIn()
        {
            ...
            switch (this.PageLoadAnimation)
            {
                case PageAnimation.SlideAndFadeInFromBottom:
                    ...
                    // Start the animation.
                    await this.SlideAndFadeInFromBottom(this.SlideSeconds, this.SlideDistance);
        ...
        public async Task AnimateOut()
        {
            ...
            switch (this.PageLoadAnimation)
            {
                case PageAnimation.SlideAndFadeOutToBottom:
                    ...
                    // Start the animation.
                    await this.SlideAndFadeOutToBottom(this.SlideSeconds, this.SlideDistance);
