...
namespace BlackSpiritHelper
{
    ...
    /// </summary>
    /// <typeparam name="Parent">The parent class to be the attacked property.</typeparam>
        ...
        where Parent : new()
    {
        ...
        /// <summary>
        /// The callback event when the <see cref="ValueProperty"/> is changed, even if it is the same valie.
        /// </summary>
        /// <param name="d">The UI element that had it's property changed.</param>
